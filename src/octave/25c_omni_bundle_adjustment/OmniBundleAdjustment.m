...
[_, _, observations_for_landmark] = computeMeasurementAndAssociations(XR_true, XL_true, K, xi);
...
[associations, Z, _] = computeMeasurementAndAssociations(XR_true, XL_true, K, xi);
...
[XR, XL, chi_stats, num_inliers]=doBundleAdjustment(XR_guess, XL_guess, Z, K, xi,
							associations, 
							num_poses, 
							num_landmarks, 
							num_iterations, 
